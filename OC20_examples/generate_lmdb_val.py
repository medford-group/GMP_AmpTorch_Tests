...
if __name__ == "__main__":
    ...
    #dirname = sys.argv[4]
    #os.chdir(dirname)
    training_data = pickle.load( open( "./images/images_s2ef_val_id_{}.p".format(dataset_index), "rb" ) )
    lmdb_data_dirname = "lmdbs_sigma{}_MCSH{}_double/".format(nsigmas ,MCSHs_index)
    lmdb_data_filename = lmdb_data_dirname+ "val_{}.lmdb".format(dataset_index)
