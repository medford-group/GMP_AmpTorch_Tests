...
​
​
def construct_lmdb(images,lmdb_path, nsigmas, MCSHs_index):
    """
...
​
    ...
    scaling =  {"type": "normalize", "range": (-1.0, 1.0),"elementwise":False, "threshold":1e-8}
...
​
    ...
    torch.save(normalizers, "normalizers_{}_{}_double.pt".format(nsigmas, MCSHs_index))
​
    db = lmdb.open(
        lmdb_path,
...
if __name__ == "__main__":
    ...
    #dirname = sys.argv[4]
    #os.chdir(dirname)
    training_data = pickle.load( open( "./images/images_s2ef_train_20M_0.p", "rb" ) )
    lmdb_data_dirname = "lmdbs_sigma{}_MCSH{}_double/".format(nsigmas ,MCSHs_index)
    lmdb_data_filename = lmdb_data_dirname+ "0.lmdb"
    construct_lmdb(training_data,lmdb_path=lmdb_data_filename, nsigmas = nsigmas, MCSHs_index = MCSHs_index)