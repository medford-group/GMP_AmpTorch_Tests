...
with open(filename) as fp:
    ...
    for line in Lines[9:3063]:
        temp = line.strip().split()
        remove_list.append(int(temp[0]))
print(len(remove_list))
read_index_list = list(set(range(1,133886)) - set(remove_list))
print(len(read_index_list))


data = {}

for i in read_index_list:
...
with open('pruned_qm9.json', 'w') as fp:
